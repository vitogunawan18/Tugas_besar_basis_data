<?php
session_start();
include 'config/database.php'; // Pastikan file ini berisi koneksi ke database Anda
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($row = $result->fetch_assoc()) {
        if ($password === $row['password']) { // tanpa hashing
...
<head>
    ...
    <title>Login Administrator - Toko Gadget POS</title>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="" id="loginForm">
            <div class="form-group">
                <label for="username">ID Administrator</label>
            ...
            <button type="submit" class="btn-login">
                ...
                <span class="btn-text">Login Administrator</span>
            </button>
        </form>

        <div class="divider">atau</div>

        <a href="index.php" class="kasir-link">
